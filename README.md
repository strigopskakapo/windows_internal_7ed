...
- Notez que ces tailles ne représentent pas les limites architecturales de ces plates-formes.
- 64 bits d'espace d'adressage représentent plus de 17 milliards de Go, mais le matériel actuel 64 bits limite cela à des valeurs plus petites.
- Et les limites de mise en œuvre de Windows dans les versions actuelles de Windows 64 bits réduisent encore cela à 8192 Go (8 To).

<p align="center"><img src="https://i.imgur.com/ZKjtf7T.png" width="400px" height="auto"></p>
